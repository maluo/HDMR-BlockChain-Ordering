...
public class ContinuousKnapsack {
    ...
    protected List<ItemUnit> itemList   = new ArrayList<ItemUnit>();
    ...
    public List<ItemUnit> calcSolution() {
        int n = itemList.size();
    ...
    public void add(String name, double weight, double value) {
        ...
        itemList.add(new ItemUnit(name, weight, value));
        setInitialStateForCalculation();
    }
