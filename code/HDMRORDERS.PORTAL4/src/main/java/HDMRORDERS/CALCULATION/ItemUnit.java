package HDMRORDERS.CALCULATION;

public class ItemUnit implements Comparable {
    ...
    public ItemUnit(double _weight, double _value) {
        setWeight(_weight);
        setValue(_value);
    }

    public ItemUnit(String _name, double _weight, double _value) {
        setName(_name);
        setWeight(_weight);
        setValue(_value);
    }
